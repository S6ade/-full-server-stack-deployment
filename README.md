...
```
5. **Финальная проверка:** Откройте в браузере локальной машины адрес *http://localhost/testsite*. Вы увидите главную страницу с рабочей ссылкой, ведущей на вторую страницу сайта.
----
### **Итог**
